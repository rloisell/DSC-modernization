...
### Director Codes Catalog (NEW 2026-02-20)
- **Feature**: Admin management for legacy `Director_Code` catalog entries
- **API endpoint**: `GET/POST/PUT /api/admin/director-codes`
- **Use case**: Maintain director codes referenced by legacy expense activity records
