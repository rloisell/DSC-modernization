...
3.a Add a WorkItem create helper and UI: `src/DSC.WebClient/src/api/WorkItemService.js` now exports `createWorkItemWithLegacy`; `src/DSC.WebClient/src/pages/Activity.jsx` includes a create form for legacy fields.
